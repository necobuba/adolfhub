if game.GameId == 257061226 or game.GameId == 115797356 or game.GameId == 228573408 or game.GameId == 2265345016 or game.GameId == 1071153038 or game.PlaceId == 2384168338 then
...
loadstring(game:HttpGet(('https://raw.githubusercontent.com/necobuba/adolfhub/main/tesis4.lua'),true))()
end
else
print("NOT FOUND")
end
